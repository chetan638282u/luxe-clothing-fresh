      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[340px] max-w-[calc(100vw-2rem)] h-[480px] max-h-[calc(100dvh-8rem)] flex flex-col rounded-xl overflow-hidden shadow-2xl border border-white/10"
